...
<body class="page-body">
	...
	<div class="container-center">
		<div class="card">
			...
			<form:form id="codeGroup" modelAttribute="codeGroup" class="form-area">
				...
				<div class="form-row">
					...
					<form:input path="groupName" cssClass="form-input" readonly="true"/>
					<div class="error-text">
				...
				<div class="button-group">
					<button type="button" class="btn-primary" id="btnEdit">
						<spring:message code="action.edit" />
					</button>

					<button type="submit" class="btn-danger" id="btnRemove">
